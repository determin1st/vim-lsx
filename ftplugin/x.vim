...
set cpo&vim
map! <S-Insert> *
nnoremap <silent> <expr>  g:NERDTree.IsOpen() ? "\:NERDTreeClose" : bufexists(expand('%')) ? "\:NERDTreeFind" : "\:NERDTree"
vmap  "*d
...
nnoremap <silent> \\ :let tmp=@/|s:/:\\:ge|let @/=tmp|noh
nnoremap <silent> \/ :let tmp=@/|s:\\:/:ge|let @/=tmp|noh
...
set encoding=utf-8
set expandtab
set fileencodings=utf-bom,utf-8,cp1251,cp866
set fileformats=unix,dos,mac
set foldopen=block,hor,insert,jump,mark,percent,quickfix,search,tag
set formatoptions=rqn
set formatlistpat=^\\s*\\(\\d\\|[-*]\\)\\+[\\]:.)}\\t\ ]\\s*
set guifont=Anonymous\ Pro:h48:cRUSSIAN
set guioptions=ce
set helplang=en
set hidden
set hlsearch
...
set nomore
set renderoptions=type:directx,gamma:1.0,geom:1,renmode:0,taamode:0
set report=0
set ruler
set runtimepath=~/vimfiles,C:\\Program\ Files\ (x86)\\Vim/vimfiles,C:\\Program\ Files\ (x86)\\Vim\\vimfiles\\bundle\\limelight.vim,C:\\Program\ Files\ (x86)\\Vim\\vimfiles\\bundle\\nerdtree,C:\\Program\ Files\ (x86)\\Vim\\vimfiles\\bundle\\vim-less,C:\\Program\ Files\ (x86)\\Vim\\vimfiles\\bundle\\vim-ls,C:\\Program\ Files\ (x86)\\Vim\\vimfiles\\bundle\\vim-signature,C:\\Program\ Files\ (x86)\\Vim\\vim81,C:\\Program\ Files\ (x86)\\Vim\\vimfiles\\bundle\\vim-signature\\after,C:\\Program\ Files\ (x86)\\Vim/vimfiles/after,~/vimfiles/after
set scrolloff=10
...
silent only
silent tabonly
cd D:/soft/DEV/VIM/vimfiles/bundle/vim-ls/ftplugin
...
tabnew
tabrewind
edit D:/soft/DEV/VIM/vimfiles/bundle/vim-ls/compiler/ls.vim
...
normal! 08|
tabnext
edit D:/soft/DEV/VIM/vimfiles/ftplugin/ls.vim
set splitbelow splitright
set nosplitbelow
set nosplitright
wincmd t
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 21 - ((12 * winheight(0) + 7) / 15)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
21
...
setlocal nowrap
setlocal wrapmargin=0
let s:l = 212 - ((11 * winheight(0) + 7) / 15)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
212
...
set stal=1
badd +17 ls.vim
badd +7 D:/soft/DEV/VIM/vimfiles/bundle/vim-ls/ftdetect/ls.vim
badd +2 D:/soft/DEV/VIM/vimfiles/bundle/vim-ls/readme.md
badd +14 D:/soft/DEV/VIM/vimfiles/ftplugin/ls.vim
badd +27 D:/soft/DEV/VIM/vimfiles/bundle/vim-ls/compiler/ls.vim
badd +10 D:/soft/DEV/VIM/vimfiles/bundle/vim-ls/syntax/ls.vim
badd +257 D:/soft/DEV/VIM/vimfiles/bundle/vim-ls/indent/ls.vim
