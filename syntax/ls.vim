...
" Matches ECMAScript built-in globals.
syntax match lsGlobal /\<\%(TextDecoder\|TextEncoder\|AbortController\|Uint8Array\|BigInt\|WeakMap\|ReadableStream\|Promise\|Proxy\|Array\|Boolean\|Date\|Function\|JSON\|Math\|Number\|Object\|RegExp\|String\|\%(Syntax\|Type\|URI\)\?Error\|is\%(NaN\|Finite\)\|parse\%(Int\|Float\)\|\%(en\|de\)codeURI\%(Component\)\?\)\>/
